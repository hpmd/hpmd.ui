...
// Component: b-table
export declare class HmTable extends BvComponent {
    // Public methods
    refresh: () => void
    clearSelected: () => void
    selectAllRows: () => void
...
export declare class HmTableLite extends BvComponent {
    // Props
    id?: string
    items: Array<any> | BvTableProviderCallback
    fields?: BvTableFieldArray
...
export declare class HmTableSimple extends BvComponent {
    // Props
    id?: string
    tableClass?: string
    tabelVariant?: BvTableVariant | string
...
// Component: b-tbody
export declare class HmTbody extends BvComponent {
    tbodyTransitionProps?: BvTableTbodyTransitionProps
    tbodyTransitionHandlers?: BvTableTbodyTransitionHandlers
}

// Component: b-thead
export declare class HmThead extends BvComponent {
    headVariant?: BvTableHeadFootVariant | string
}

// Component: b-tfoot
export declare class HmTfoot extends BvComponent {
    footVariant?: BvTableHeadFootVariant | string
}

// Component: b-tr
export declare class HmTr extends BvComponent {
    variant?: BvTableVariant | string
}

// Component: b-th
export declare class HmTh extends BvComponent {
    variant?: BvTableVariant | string
...
// Component: b-td
export declare class HmTd extends BvComponent {
    variant?: BvTableVariant | string
    colspan?: number | string
    rowspan?: number | string
    stackedHeading?: number | string
